...
- src/dynamsoft.imagecore-1.5.9.wasm & dynamsoft.imageio.js & dynamsoft.imageio_wasm-1.6.1.js
These files contain functionalities for image input & output + decode & encode.

- src/dynamsoft.pdfReader-1.4.10.wasm & dynamsoft.pdfWriter-1.4.1.wasm
These files contain functionalities for PDF reading & writing when the library is running in the wasm-mode.
...
- DynamsoftServiceSetup.msi / DynamsoftServiceSetupTrial.msi
For Windows
