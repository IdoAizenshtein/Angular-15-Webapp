...
@Component({
    selector: 'app-cash-editor',
    templateUrl: './cash-editor.component.html',
    encapsulation: ViewEncapsulation.None,
    preserveWhitespaces: false
})
export class CashEditorComponent implements OnChanges {
    ...
    constructor(
        ...
        this.fields = [
            ...
            },
            {
                ...
                options: ['AVG_3_MONTHS', 'USER_DEFINED_TOTAL'].map((val, idx) => {
                    return {
                        label:
                            idx === 1
                                ? 'קבוע : '
