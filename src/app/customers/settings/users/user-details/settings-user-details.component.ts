...
import {BehaviorSubject, combineLatest, defer, EMPTY, merge, Observable, of, Subject} from 'rxjs';
import {distinctUntilKeyChanged, filter, first, map, startWith, switchMap, takeUntil, tap, withLatestFrom} from 'rxjs/operators';
...
import {CompanyUser, SettingsUsersComponent} from '../settings-users.component';
...
export class SettingsUserDetailsComponent
    ...
    commitChanges() {
        ...
        this.sharedComponent.mixPanelEvent(this.userId === 'new' ?'new user' : 'edit user');
