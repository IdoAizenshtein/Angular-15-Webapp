   ...
   timer(5000, 5000)
    ...
    this.deletedSolkim$ = this.byTokenGroups$.pipe(
      ...
      switchMap(([groups, selectedCompany]) =>
        this.sharedService.getDeletedSolkim({
          companyId: selectedCompany.companyId,
      ...
      onApprove: () => {
        ...
        this.sharedService
          .changeClearingAgencyLinkedAccount({
            oldCompanyAccountId: itemChild.account.companyAccountId,
            newCompanyAccountId: $event.companyAccountId,
          ...
          .subscribe((resp) => {
            ...
            this.changeSolekLinkedAccountPrompt.syncSelection();
          });
      },
      syncSelection: () => {
