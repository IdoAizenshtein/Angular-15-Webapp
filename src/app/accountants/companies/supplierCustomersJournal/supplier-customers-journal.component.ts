...
@Component({
    templateUrl: './supplier-customers-journal.component.html',
    encapsulation: ViewEncapsulation.None,
    preserveWhitespaces: false
})
export class SupplierCustomersJournalComponent
    ...
    journalTrans(): void {
        this.loader = true;
        this.sharedService.suppliersCustomersOv().subscribe((response: any) => {
            const journalTrans = response ? response['body'] : response;
            // companyId
            //     :
            //     "42d546ce-21f6-59c1-e053-650aa8c004c5"
            // dataReceiveDate
            //     :
            //     1655726082332
            // dbName
            ...
            this.companiesSrc = journalTrans ? JSON.parse(JSON.stringify(journalTrans)) : [];
