...
@Component({
    selector: 'app-archives-advanced-search',
    templateUrl: './archives-advanced-search.component.html',
    encapsulation: ViewEncapsulation.None,
    preserveWhitespaces: false,
    animations: [slideInOut]
})
export class ArchivesAdvancedSearchComponent implements OnDestroy, OnInit {
    showPanelDD = false;
    ...
    search(): any {
        if (
            ...
            (!this.advancedSearchParams.get('invoiceDateFrom').value &&
                this.advancedSearchParams.get('invoiceDateTill').value) ||
            (!this.advancedSearchParams.get('totalBeforeMaamFrom').value &&
                this.advancedSearchParams.get('totalbeforeMaamTill').value) ||
            (this.advancedSearchParams.get('totalBeforeMaamFrom').value &&
                !this.advancedSearchParams.get('totalbeforeMaamTill').value) ||
            (!this.advancedSearchParams.get('totalIncludeMaamFrom').value &&
                this.advancedSearchParams.get('totalIncludeMaamTill').value) ||
            (this.advancedSearchParams.get('totalIncludeMaamFrom').value &&
                !this.advancedSearchParams.get('totalIncludeMaamTill').value) ||
            (this.advancedSearchParams.get('supplierHp').value &&
                this.advancedSearchParams.get('supplierHp').errors &&
                (this.advancedSearchParams.get('supplierHp').errors['idILInvalid'] ||
                    this.advancedSearchParams.get('supplierHp').errors['minlength'])) ||
            (this.advancedSearchParams.get('batchNumber').value &&
                this.advancedSearchParams.get('batchNumber').errors) ||
